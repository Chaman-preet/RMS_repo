 ...
 public void enterurl() throws IOException, InterruptedException
{
 ...
 @Test
	public void loginanalyst() throws InterruptedException{
		log.info("Logging analyst");
		Loginclass objloginanalyst=PageFactory.initElements(driver,Loginclass.class);
		System.out.println("\n" +"///---actionclass.loginanalyst()---///");
		Thread.sleep(1000);
		objloginanalyst.enteruser(5);
		  Thread.sleep(1000);
		  objloginanalyst.enterpswd(5);
		  objloginanalyst.log();
		  Thread.sleep(2000);
	}
...
public void newreq() throws InterruptedException{
	...
	public void closetest() throws IOException
	{
		...
		FileUtils.copyFile(scrFile, new File("C://Users//chaman.preet//Desktop//screenshotana.png"));
		*/
		driver.quit();
	}
}
