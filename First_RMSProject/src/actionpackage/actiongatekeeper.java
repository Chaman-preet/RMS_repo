 ...
 public void enterurl() throws IOException, InterruptedException
{
 ...
 @Test
	public void logingate() throws InterruptedException{
		log.info("Logging gatekeeper");
		 Loginclass objlogingate=PageFactory.initElements(driver,Loginclass.class);
		System.out.println("\n" +"///---actionclass.logingate()---///");
		Thread.sleep(1000);
		objlogingate.enteruser(4);
		  Thread.sleep(1000);
		  objlogingate.enterpswd(4);
		  objlogingate.log();
		  Thread.sleep(2000);
	}
...
public void newreq() throws InterruptedException{
	...
	public void closetest() throws IOException
	{
		...
		FileUtils.copyFile(scrFile, new File("C://Users//chaman.preet//Desktop//screenshotgate.png"));*/
