 ...
 public void enterurl() throws IOException, InterruptedException
{
	...
	@Test
	public void loginreq() throws InterruptedException, IOException{
		 ExcelUtils.setexcel("C:\\RMS_workspace\\First_RMSProject\\RMS data.xlsx", "Sheet1");
		log.info("Logging requestor");
		 Loginclass objloginreq=PageFactory.initElements(driver,Loginclass.class);
		System.out.println("\n" +"///---actionclass.loginreq()---///");
		Thread.sleep(1000);
		objloginreq.enteruser(3);
		  Thread.sleep(1000);
		  objloginreq.enterpswd(3);
		  objloginreq.log();
		  Thread.sleep(2000);
	}
...
public void newreq() throws InterruptedException{
	...
	/*	log.info("Taking screenshot and closing window");
		...
		FileUtils.copyFile(scrFile, new File("C://Users//chaman.preet//Desktop//screenshotreq.png"));*/
